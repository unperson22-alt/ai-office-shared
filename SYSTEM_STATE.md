...
|`INFRA-001`|prophet-bot          |Webhook не подключён в Railway Dashboard — бот не получает updates. Ждёт ручного действия Влада: Settings → reconnect GitHub repo.|⚠️ Ждёт Влада        |
