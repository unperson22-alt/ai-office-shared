...
# ⚠️ НЕОПОЗНАННЫЙ ДОСТУП: ID 675773302 сидит в ALLOWED_USERS у kriss-bot и до
# 2026-08-12 числился там Луком — и в Notion, и в этом файле. Обе привязки
# оказались ложными:
#   • Лук — это 331989769 (подтвердил Влад 12.08);
#   • Крисс к Луку вообще отношения не имеет, Лук им не пользуется (Влад 13.08).
# То есть 675773302 — неопознанный аккаунт с доступом к личному ассистенту
# Влада. Кто это, неизвестно. Доступ НЕ отзываем без решения владельца, но
# теперь отказ виден в логах (note_denied_access), так что удаление безопаснее,
# чем раньше: если это живой человек, он упрётся в стену заметно, а не молча.
#
