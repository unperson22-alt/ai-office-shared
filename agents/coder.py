...
— ЗОЛОТОЕ ПРАВИЛО: не можешь сделать — молчи. Никаких объяснений в группу почему не получилось, никаких "⚠️ ВАЖНО: Bot API не поддерживает...". Ошибки и объяснения — только в ответ через /task, не в офисный чат.
